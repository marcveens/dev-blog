...
export const addLineNumbers = (hljs: HLJSApi) => {
  ...
  function edgeGetSelectedCodeLines(selection: Selection): string {
    ...
    if (firstLineNumber != lastLineNumber) {
      ...
      for (let i = firstLineNumber + 1; i < lastLineNumber; ++i) {
        ...
        const codeLineElt = hljsLnTable.querySelector(codeLineSel) as HTMLElement;
  ...
  function lineNumbersValue(value: string, options?: LineNumbersOptions): string {
  ...
  function lineNumbersInternal(element: HTMLElement, options?: LineNumbersOptions): string {
  ...
  function addLineNumbersBlockFor(inputHtml: string, options: LineNumbersOptions): string {
   ...
   */
  function mapOptions(element: HTMLElement, options?: LineNumbersOptions): LineNumbersOptions {
    options = options || {};
    return {
  ...
  function getStartFromOption(element: HTMLElement, options?: LineNumbersOptions): number {
