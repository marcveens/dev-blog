...
export const PostPreviewBlock = (props: PostPreviewProps) => {
  ...
  return (
    <Link href={slug} className={cx('group flex flex-col items-start rounded-2xl bg-contrast/[.05] p-7 text-contrast', className)}>
      ...
      <div className="flex grow flex-col gap-7">
        ...
        <p className="text-base leading-normal text-contrast/[.8]">{cutStringToWholeWord(strippedDescription, 100)}</p>
